...
main() {
    ...
    ptxInjectCheck( ptx_inject_variable_info_by_name(ptx_inject, inject_func_idx, "x_y", NULL, NULL, NULL, &registers[REGISTER_X_Y].name) );
    ptxInjectCheck( ptx_inject_variable_info_by_name(ptx_inject, inject_func_idx, "z", NULL, NULL, NULL, &registers[REGISTER_Z].name) );
    ptxInjectCheck( ptx_inject_variable_info_by_name(ptx_inject, inject_func_idx, "w", NULL, NULL, NULL, &registers[REGISTER_W].name) );
